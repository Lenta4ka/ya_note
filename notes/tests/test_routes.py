...
class TestRoutes(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.notes = Note.objects.create(
            ...
            title='Заголовок',
            slug='Slug')
        #cls.notes = Note.objects.create(title='Заголовок', text='Текст',slug='Slug',author='Лента')
    ...
    def test_availability_for_comment_edit_and_delete(self):
        users_statuses = ((self.author, HTTPStatus.OK),(self.reader, HTTPStatus.NOT_FOUND),)
